...
refelem(m::Mesh{Segment})       = LagrangeP1(1)
refelem(m::Mesh{Triangle})      = LagrangeP1(2)
refelem(m::Mesh{Tetrahedron})   = LagrangeP1(3)
refelem(m::Mesh{Quadrilateral}) = LagrangeQ1(2)
refelem(m::Mesh{Hexahedron})    = LagrangeQ1(3)
